...
class CaseCarte:  # a l'air de servir à rien d'après : https://api.arcade.academy/en/stable/examples/procedural_caves_bsp.html
...
class GenerateurCarte:
        ...
        for group in groups:
            ...
            for room in group:
                ...
                for other in room_dict[key]:
                    if not other[0] in group and other[3] < shortest_distance: #room_dict[key].append((other, adj[1], 'cols', self.distance_between_rooms(room, other)))
    ...
    def in_out(self, graphe, dico_relation):
        liste=[]
        #Je regarde s'il y a des pièces reliés qu'une seule fois 
    ...
    def get_for_game2(self):
        ...
        #  ajouter un cadre de 1 autour de la matrice pour éviter les sorties de la carte et rendre l'affichage des bords plus propre
